...
inds = coef_table_out$Coefficient %in% c("T0","DBTT","C")
coef_table_out$Coefficient[inds] = paste(coef_table_out$Coefficient[inds],'(\u00B0C)')

# USE -> US, etc
coef_table_out$Coefficient[coef_table_out$Coefficient == 'USE'] = 'US'
coef_table_out$Coefficient[coef_table_out$Coefficient == 'LSE'] = 'LS'
